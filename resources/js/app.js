...
import AvatarWithPreview from "./components/common/AvatarWithPreview.vue";
...
import UserSelect2 from "./components/common/UserSelect2.vue";
import AppMonthYearPicker from "./components/common/AppMonthYearPicker.vue";
...
app.component("AvatarWithPreview", AvatarWithPreview);
app.component("CreatedInfo", CreatedInfo);
app.component("SearchInput", SearchInput);
app.component("EmailInput", EmailInput);
app.component("PhoneInput", PhoneInput);
app.component("NumberInput", NumberInput);
app.component("UserSelect2", UserSelect2);
app.component("AppMonthYearPicker", AppMonthYearPicker);
