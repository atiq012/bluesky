    ...
    columns: [
...

        {
            ...
            render: function (data, type, row) {
                ...
                var cat_type = row.parent_id != null ? "Sub Category" : "Category";
                var html = "";
                if (row.parent_id != null) {

                    html += row.name + " <span style='padding:2px; background-color: #ecfcfd; color: #539cb3; font-size: 10px; white-space: nowrap;'> " + cat_type + "</span>";

                    html += "<br>";
                    html += "<span class='text-primary' style='font-size: 11px;'> Category: " + row.parent_category_name + "</span>";
                } else {
                    html += row.name + " <span style='padding:2px; background-color: rgb(228, 227, 246); color: rgb(121, 68, 235);  font-size: 10px;'> " + cat_type + "</span>";
        ...
        },
        {
            ...
            render: function (data, type, row) {
                ...
                html += '<span class="text-primary">';
                html += row.updated_by ? row.updated_at : "" + "</span>";
                return html;
            },
        },
        {
        ...
        $(".delete-item").on('click', function (e) {
            ...
            iziToast.question({
                ...
                onClosed: async function (instance, toast, closedBy) {
                    ...
                    if (closedBy == 'yes') {
                        const response = axiosInstance.post("deleteCategory", { 'id': idd })
                            .then(response => {
...
<template>
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="breadcrumb-title pe-3">Category & SubCategory</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item">
                        <router-link :to="{ name: 'categoryList' }">Category & Sub Category</router-link>
                    </li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
            <div class="btn-group">
                <router-link :to="{ name: 'categoryCreate' }" class="btn btn-primary btn-sm">
                    <i class="fa fa-circle-plus"></i>Create
                </router-link>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body">
                                <table id="log" width="100%" class="table table-sm table-dark"
                                    style="color: red;--bs-table-color:lime">
                                    <thead>
                                        <tr>
                                            <th>Action</th>
