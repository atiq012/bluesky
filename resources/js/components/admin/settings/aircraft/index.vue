...
const options = {
    ...
    "drawCallback": function (settings) {
        ...
        $(".edit-item").on('click', function (e) {
            ...
            router.push({ name: 'aircraftEdit', params: { id: itemIdd } });
        });
        ...
        $(".delete-item").on('click', function (e) {
            ...
            iziToast.question({
                ...
                id: 'question',
                zindex: 999,
                message: 'Want to delete this Aircraft?',
                position: 'center',
                buttons: [
                ...
                onClosed: async function (instance, toast, closedBy) {
                    ...
                    if (closedBy == 'yes') {
                        const response = axiosInstance.post("deleteAircraft", { 'id': idd });
                        getListValues();
                        Notification.showToast('s', 'Successfully Aircraft Deleted.');
                    } else {
...
async function getListValues() {
    try {
        ...
        const response = await axiosInstance.get("getAircraftTypeDesignator");
