...
const options = {
    ...
    columns: [
        { data: "DT_RowIndex", title: "SL" },
        {
            ...
            render: function (data, type, row) {
                var html = "";
                html += '<img src="' + row.logo + '" width="50" height="50" alt="logo">';
                return html;
            },
        },
        {
    ...
    "drawCallback": function (settings) {
        ...
        $(".edit-item").on('click', function (e) {
            ...
            router.push({ name: 'airlinesEdit', params: { id: itemIdd } });
        });
        ...
        $(".delete-item").on('click', function (e) {
            ...
            iziToast.question({
                ...
                id: 'question',
                zindex: 999,
                message: 'Want to delete this Airlines?',
                position: 'center',
                buttons: [
                ...
                onClosed: async function (instance, toast, closedBy) {
                    ...
                    if (closedBy == 'yes') {
                        const response = axiosInstance.post("deleteAirlines", { 'id': idd });
                        getListValues();
                        Notification.showToast('s', 'Successfully Airlines Deleted.');
                    } else {
...
async function getListValues() {
    try {
        ...
        const response = await axiosInstance.get("getAirlines");
...
<template>
        ...
        :breadcrumbs="[
            ...
            { label: 'Settings', to: { name: 'airlinesList' } },
    ...
    >
        <template #actions>
            <div class="btn-group">
                <router-link :to="{ name: 'airlinesCreate' }" class="btn btn-primary btn-sm">
                    <i class="fa fa-circle-plus"></i> Airlines
                </router-link>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-agency">
                ...
                <div class="info-agency-content">
                    <span class="info-agency-text">Total Aircraft</span>
